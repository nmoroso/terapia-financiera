      ...
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          >
            ...
            <h2 className="text-2xl font-black tracking-tight text-slate-900 md:text-4xl leading-tight mb-5">
              El dinero es una herramienta. Mi trabajo es ayudarte a usarla bien.
            </h2>
            <p className="text-sm text-slate-600 mb-4" style={{ lineHeight: 1.7 }}>
